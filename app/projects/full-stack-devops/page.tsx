...
const fullStackDevOpsProjects = projects.filter(
  (project) => project.category === 'full-stack-devops'
);
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 card-container">
        {fullStackDevOpsProjects.map((project, index) => (
          <Card
...
export default FullStackDevOpsProjectsPage;
