...
export const experiences: TimelineViewerData[] = [
  {
    title: 'IT Specialist I–IV · NB Power, New Brunswick',
    date: 'Oct. 2025 – Present',
    description:
      'Full-stack and Platform Engineer at a provincial electrical utility. Design, develop, integrate, and support enterprise applications and internal platforms using Microsoft technologies.',
    latest: true,
  },
  {
    title: 'Part-Time Consultant · CGI, Quebec',
